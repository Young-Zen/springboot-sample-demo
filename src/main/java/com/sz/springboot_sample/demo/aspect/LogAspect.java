...
import com.sz.springboot_sample.demo.config.property.LogProperties;
import com.sz.springboot_sample.demo.dto.LogDTO;
import com.sz.springboot_sample.demo.thread.threadlocal.LogHolder;
import com.sz.springboot_sample.demo.util.AspectUtils;
...
public class LogAspect {
     ...
     */
    @Around(value = "com.sz.springboot_sample.demo.aspect.Pointcuts.controllerAspect()")
     ...
     * @param joinPoint
     */
    @Before(value = "com.sz.springboot_sample.demo.aspect.Pointcuts.controllerAspect()" +
            "||com.sz.springboot_sample.demo.aspect.Pointcuts.serviceAspect()" +
            "||com.sz.springboot_sample.demo.aspect.Pointcuts.daoAspect()")
     ...
     * @param result
     */
    @AfterReturning(value = "com.sz.springboot_sample.demo.aspect.Pointcuts.controllerAspect()" +
            "||com.sz.springboot_sample.demo.aspect.Pointcuts.serviceAspect()" +
            "||com.sz.springboot_sample.demo.aspect.Pointcuts.daoAspect()", returning = "result")
    ...
    @AfterThrowing(value = "com.sz.springboot_sample.demo.aspect.Pointcuts.controllerAspect()", throwing = "cause")
